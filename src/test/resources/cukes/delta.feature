...
Feature: Delta service
  ...
  Scenario: Find content with 2 dates given
	And I write urn:cucumber:a:b:c1 for content content as if in date 1980-01-01T00:00:00.000Z
    ...
    Then Delta response is [ "urn:cucumber:a:b:c" ]
  ...
  Scenario: Find content with no dates given
    ...
    And I write urn:cucumber:a:b:c2 for content content as if in date 1980-01-01T01:00:00.000Z
    And I write urn:cucumber:a:b:c3 for content content as if in date 1980-01-01T02:00:00.000Z
    When I ask for delta for urn:cucumber:a:b for start date 1970-01-01T02:00:00.000Z and end date null
    Then Delta response is [ "urn:cucumber:a:b:c1", "urn:cucumber:a:b3:c2", "urn:cucumber:a:b3:c3" ]
